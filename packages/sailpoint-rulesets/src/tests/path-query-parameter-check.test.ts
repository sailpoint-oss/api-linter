...
const jsonParametersWithFieldsField: OpenAPIV3.OperationObject = {
...
const jsonParametersWithoutRequiredField: OpenAPIV3.OperationObject = {
  operationId: "listAccounts",
  tags: ["Accounts"],
  summary: "Accounts List This is a test",
  description:
...
const jsonParametersEmpty: OpenAPIV3.OperationObject = {
  operationId: "listAccounts",
  tags: ["Accounts"],
  summary: "Accounts List This is a test",
  description:

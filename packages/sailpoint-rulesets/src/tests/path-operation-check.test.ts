...
let jsonPaths: OpenAPIV3.PathItemObject = {
  get: {
...
let invalidAccessProfileOperationId: OpenAPIV3.PathItemObject = {
  get: {
    tags: ["Access Profiles"],
    summary: "List Access Profiles",
...
let invalidDeleteAndPatchAccessProfileOperationIds: OpenAPIV3.PathItemObject = {
  get: {
    tags: ["Access Profiles"],
    summary: "List Access Profiles",
    operationId: "listAccessProfiles",
...
describe("Path Operation Check Function", () => {
  ...
  test("Should return errors for invalid operationId", () => {
    const result = operationCheck(invalidAccessProfileOperationId, {
      rule: ruleNumber,
    });
    expect(result).toEqual([
      {
  ...
  test("Should return errors for invalid operationIds for delete and patch endpoints", () => {
    const result = operationCheck(
      invalidDeleteAndPatchAccessProfileOperationIds,
      { rule: ruleNumber },
    );
    expect(result).toEqual([
      {

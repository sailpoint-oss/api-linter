...
const jsonValidPagination: OpenAPIV3.OperationObject = {
  parameters: [
    {
      in: "query",
      name: "limit",
...
const jsonMissingLimit: OpenAPIV3.OperationObject = {
  parameters: [
    {
      in: "query",
      name: "offset",
...
const jsonMissingOffset: OpenAPIV3.OperationObject = {
  parameters: [
    {
      in: "query",
      name: "limit",
...
const jsonMissingLimitAndOffset: OpenAPIV3.OperationObject = {
  parameters: [
    {
      in: "query",
      name: "count",
...
const jsonLimitMissingMinimum: OpenAPIV3.OperationObject = {
  parameters: [
    {
      in: "query",
      name: "limit",
...
const jsonLimitMissingMaximum: OpenAPIV3.OperationObject = {
  parameters: [
    {
      in: "query",
      name: "limit",
...
const jsonLimitMissingMinimumAndMaximum: OpenAPIV3.OperationObject = {
  parameters: [
    {
      in: "query",
      name: "limit",
...
describe("Path pagination offset and limit check", () => {
  ...
  test("Should return an error message if limit and offset are missing from query parameters", () => {
    const result = pathQueryParameterPaginationCheck(
      jsonMissingLimitAndOffset,
      { rule: ruleNumber },
    );
    expect(result).toEqual([
      {
  ...
  test("Should return an error message if maximum and minimum are not defined for the limit query parameter", () => {
    const result = pathQueryParameterPaginationCheck(
      jsonLimitMissingMinimumAndMaximum,
      { rule: ruleNumber },
    );
    expect(result).toEqual([
      {

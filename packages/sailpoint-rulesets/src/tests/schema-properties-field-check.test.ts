...
let allOfParametersCheck: OpenAPIV3.SchemaObject = {
  allOf: [
    {
      type: "object",
      required: ["name"],
...
let allOfParametersCheckWithMissingExamples: OpenAPIV3.SchemaObject = {
  allOf: [
    {
      type: "object",
      required: ["name"],
...
let singleObjectParameterCheckWithMissingExamples: OpenAPIV3.SchemaObject = {
  type: "object",
  properties: {
    oldApproverName: {
      type: "string",
...
let singleObjectParameterCheckWithValidExamples: OpenAPIV3.SchemaObject = {
  type: "object",
  properties: {
    oldApproverName: {
      type: "string",
...
let singleParameterWithMissingExample: OpenAPIV3.SchemaObject = {
  type: "string",
...
let singleParameterWithValidExample: OpenAPIV3.SchemaObject = {
  type: "string",
  enum: ["GRANT_ACCESS", "REVOKE_ACCESS"],
  description:
    "Access request type. Defaults to GRANT_ACCESS. REVOKE_ACCESS type can only have a single Identity ID in the requestedFor field. Currently REVOKE_ACCESS is not supported for entitlements.",
...
let multilevelSchemaObjectWithMissingExamples: OpenAPIV3.SchemaObject = {
  type: "object",
  properties: {
    oldApproverName: {
      type: "string",
...
let superMultilevelSchemaObject: OpenAPIV3.SchemaObject = {
  type: "object",
  properties: {
    id: {
      type: "string",
...
let itemArrayExample: OpenAPIV3.SchemaObject = {
  type: "object",
  properties: {
    requestedFor: {
      description:
...
let multiItemArrayUsecase: OpenAPIV3.SchemaObject = {
  type: "object",
  properties: {
    name: {
      type: "string",
...
let nullableExampleUsecase: OpenAPIV3.SchemaObject = {
  type: "object",
  properties: {
    oldApproverName: {
      type: "string",
...
describe("Schema Properties Field Check", () => {
  ...
  test("Should return errors for super multi-level schema object", () => {
    expect(
      ...
      {
        message:
          "Rule 304: The property warnings must have a example that is not null",
      ...
      {
        message:
          "Rule 304: The property provisioningStatus must have a example",
        path: [
          "properties",
          "items",
          "items",
  ...
  test("Should return errors with nullable true fields with missing description", () => {
    expect(
      ...
      {
        message:
          "Rule 304: The property oldApproverName must have a description",

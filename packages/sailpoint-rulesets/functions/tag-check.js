...
export default (targetVal, options, context) => {
    ...
    let results = [];
    let tagArray = [];
    if (context.document.source === undefined ||
        ...
        if (context.document.source.includes("v3")) {
            ...
            if (preloadedTags) {
                ...
                console.error("Preloaded V3 tags data not found in environment, this will not run the tags check.");
            }
        }
            ...
            if (preloadedTags) {
                ...
                console.error("Preloaded V2024 tags data not found in environment, this will not run the tags check.");
            }
        }
            ...
            if (preloadedTags) {
                ...
                console.error("Preloaded V2025 tags data not found in environment, this will not run the tags check.");
            }
        }
            ...
            if (preloadedTags) {
                ...
                console.error("Preloaded Beta tags data not found in environment, this will not run the tags check.");
            }
        }
    }
...
//# sourceMappingURL=tag-check.js.map
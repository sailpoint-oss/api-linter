    ...
    for (const [field, value] of Object.entries(targetYaml.properties)) {
        ...
        if ("properties" in value &&
            ...
            if (pathPrefix == null) {
                ...
                parseYamlProperties(value, pathPrefix + ".properties." + field, errorResults);
            }
        }
        else {
            // console.log(
...
export default (targetYaml, options, context) => {
...
//# sourceMappingURL=validate-schema-integer-number-formats.js.map
...
describe("Sorter param description", () => {
    test("Should not return any errors for valid input", () => {
        const result = parameterSorterDescriptionCheck(validSorterDescription, {
            rule: ruleNumber,
        });
        expect(result).toBeUndefined();
    });
    test("Should return an error for bad key for fields", function () {
        const result = parameterSorterDescriptionCheck(badKeyForFields, {
            rule: ruleNumber,
        });
    ...
    test("Should return an error for a dash in a field", function () {
        const result = parameterSorterDescriptionCheck(dashInFieldName, {
            rule: ruleNumber,
        });
        expect(result).to.deep.equal([
            {
    ...
    test("Should return an error for not enough new lines", function () {
        const result = parameterSorterDescriptionCheck(singleNewLine, {
            rule: ruleNumber,
        });
        expect(result).to.deep.equal([
            {
    ...
    test("Should return an error for bad intro", function () {
        const result = parameterSorterDescriptionCheck(badIntro, {
            rule: ruleNumber,
        });
        expect(result).to.deep.equal([
            {
    ...
    test("Should return an error for fields not bolded", function () {
        const result = parameterSorterDescriptionCheck(fieldsNotBolded, {
            rule: ruleNumber,
        });
        expect(result).to.deep.equal([
            {
    ...
    test("Should return an error for fields not separated", function () {
        const result = parameterSorterDescriptionCheck(fieldsNotSeparated, {
            rule: ruleNumber,
        });
        expect(result).to.deep.equal([
            {
    ...
    test("Should return an error for fields on separate lines", function () {
        const result = parameterSorterDescriptionCheck(fieldsOnSeparateLines, {
            rule: ruleNumber,
        });
        expect(result).to.deep.equal([
            {
...
//# sourceMappingURL=parameter-sorter-description-check.test.js.map
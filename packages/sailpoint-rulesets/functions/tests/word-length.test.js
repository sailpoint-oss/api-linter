...
const maxWordCountVariableTest = "This Summary is checking the variable maxWordCount is working";
describe("Word Length Function", () => {
    test("Should not return any errors for valid word length", () => {
        expect(wordCount(validSummaryLength, { rule: ruleNumber, maxWordCount: 5 })).toBeUndefined();
    });
    test("Should return errors for invalid word lengths", () => {
        expect(wordCount(invalidSummaryLength, { rule: ruleNumber, maxWordCount: 5 })).toEqual([
            {
...
//# sourceMappingURL=word-length.test.js.map
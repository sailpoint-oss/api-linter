...
function parseYamlProperties(targetYaml, field, pathPrefix, errorResults, rule) {
    if ("$ref" in targetYaml || !targetYaml.properties)
        return;
            ...
            "type" in value &&
                ...
                if ("nullable" in value &&
                    ...
                    if (!value.hasOwnProperty(field) && value[field] == null) {
                        ...
                        console.log(`Rule ${rule}: The property ${key} must have a ${field}: ${pathPrefix}.properties.${key}.${field}`);
                        ...
                        console.log(`Rule ${rule}: The property ${key} must have a ${field} that is not null: : ${pathPrefix}.properties.${key}.${field}`);
                        if (pathPrefix.split(".")[pathPrefix.split(".").length - 1] ==
                            "properties") {
                            // @ts-ignore
                            errorResults.push({
...
//# sourceMappingURL=schema-properties-field-check.js.map